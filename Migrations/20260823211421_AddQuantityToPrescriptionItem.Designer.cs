...
namespace MediFlowApi.Migrations
{
    ...
    [Migration("20260823211421_AddQuantityToPrescriptionItem")]
    partial class AddQuantityToPrescriptionItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediFlowApi.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MediFlowApi.Models.DispensingRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediFlowApi.Models.Consultation", b =>
                {
                    ...
                    b.HasOne("MediFlowApi.Models.Patient", "Patient")
                        .WithMany("consultations")
            ...
            modelBuilder.Entity("MediFlowApi.Models.DispensingRecord", b =>
                {
                    b.HasOne("MediFlowApi.Models.ApplicationUser", "Pharmacist")
                        .WithMany()
            ...
            modelBuilder.Entity("MediFlowApi.Models.Doctor", b =>
                {
                    b.HasOne("MediFlowApi.Models.ApplicationUser", "user")
                        .WithMany()
            ...
            modelBuilder.Entity("MediFlowApi.Models.Patient", b =>
                {
                    b.HasOne("MediFlowApi.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MediFlowApi.Models.ApplicationUser", null)
                        .WithMany()
